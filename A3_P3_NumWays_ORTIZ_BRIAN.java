public class A3_P3_NumWays_ORTIZ_BRIAN {
   ...
   public static long numWays(int n, int k, int [] D)   {
       ...
       long waysWithoutLastDenomination = numWays(n, k - 1, D);
       long waysWithLastDenomination = (n >= D[k]) ? numWays(n - D[k], k, D) : 0;

       return waysWithoutLastDenomination + waysWithLastDenomination;
